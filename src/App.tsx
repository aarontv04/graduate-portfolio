    ...
    <div className="relative min-h-screen text-zinc-100 font-sans selection:bg-purple-500/30 selection:text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-[-1] bg-zinc-950">
        <motion.div
          ...
          className="absolute -top-[20%] -left-[10%] h-[70vh] w-[70vw] origin-center opacity-[0.15] blur-[100px] mix-blend-screen"
        >
        ...
        <motion.div
          ...
          className="absolute -bottom-[20%] -right-[10%] h-[80vh] w-[80vw] origin-center opacity-[0.12] blur-[120px] mix-blend-screen"
        >
